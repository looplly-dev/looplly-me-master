...
CREATE INDEX idx_question_audit_log_question_id ON question_audit_log(question_id);
CREATE INDEX idx_question_audit_log_changed_by ON question_audit_log(changed_by);
CREATE INDEX idx_question_audit_log_changed_at ON question_audit_log(changed_at DESC);