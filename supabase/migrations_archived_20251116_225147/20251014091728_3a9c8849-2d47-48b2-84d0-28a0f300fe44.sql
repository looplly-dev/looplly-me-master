...
CREATE INDEX IF NOT EXISTS idx_agent_dependencies_parent ON public.agent_dependencies(parent_agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_dependencies_dependent ON public.agent_dependencies(dependent_agent_id);
