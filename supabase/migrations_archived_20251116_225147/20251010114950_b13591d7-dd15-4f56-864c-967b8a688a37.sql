...
CREATE INDEX IF NOT EXISTS idx_earning_activities_user ON public.earning_activities(user_id);
CREATE INDEX IF NOT EXISTS idx_earning_activities_status ON public.earning_activities(status);
CREATE INDEX IF NOT EXISTS idx_earning_activities_created_at ON public.earning_activities(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cint_sessions_user ON public.cint_survey_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_cint_sessions_status ON public.cint_survey_sessions(status);
CREATE INDEX IF NOT EXISTS idx_cint_sessions_created_at ON public.cint_survey_sessions(created_at DESC);
