...
CREATE TABLE IF NOT EXISTS public.streak_unlock_config (
...
CREATE INDEX IF NOT EXISTS idx_streak_unlock_config_stage ON public.streak_unlock_config(stage);
CREATE INDEX IF NOT EXISTS idx_streak_unlock_config_active ON public.streak_unlock_config(is_active) WHERE is_active = true;
