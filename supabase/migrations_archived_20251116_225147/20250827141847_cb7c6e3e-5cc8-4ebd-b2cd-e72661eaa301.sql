...
CREATE TABLE IF NOT EXISTS public.cint_config (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_cint_survey_sessions_user_id ON public.cint_survey_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_cint_survey_sessions_status ON public.cint_survey_sessions(status);
CREATE INDEX IF NOT EXISTS idx_cint_survey_sessions_survey_id ON public.cint_survey_sessions(survey_id);