      ...
      <div className="pt-4 pb-24 md:pb-20 lg:pb-8 px-0 md:px-6 lg:px-8 space-y-3">
        ...
        {(() => {
          ...
          return !level2Complete && questionsRemaining > 0 && (
            <Alert className="sticky top-0 z-50 border-amber-500/30 bg-amber-500/10 backdrop-blur-sm shadow-md">
        ...
        {level2Complete && !isVerified && (
          <Alert className="sticky top-0 z-50 border-orange-500/30 bg-orange-500/10 backdrop-blur-sm shadow-md">
