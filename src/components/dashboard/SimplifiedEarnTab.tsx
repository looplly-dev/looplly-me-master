              ...
              <TabsContent value="surveys" className="earn-tab-content">
                ...
                {cintLoading ? (
                  ...
                  cintSurveys.map((survey) => (
                    <div key={survey.id} className="py-4 pr-4 pl-2 border rounded-lg bg-card shadow-sm border-l-4 border-l-primary/50 hover:shadow-md transition-shadow">
                ...
                {availableTasks.filter(a => a.activity_type === 'survey').length === 0 ? (
                  ...
                  availableTasks.filter(a => a.activity_type === 'survey').map((activity) => (
                    <div key={activity.id} className="py-4 pr-4 pl-2 border rounded-lg bg-card shadow-sm border-l-4 border-l-primary/50 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3 flex-1">
              ...
              <TabsContent value="videos" className="earn-tab-content">
                {availableTasks.filter(a => a.activity_type === 'video').length === 0 ? (
                  ...
                  availableTasks.filter(a => a.activity_type === 'video').map((activity) => (
                    <div key={activity.id} className="py-4 pr-4 pl-2 border rounded-lg bg-card shadow-sm border-l-4 border-l-warning/50 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3 flex-1">
